...
public enum RetEnum {
    ...
    // about DID
    RET_DID_IDENTITY_CALL_CONTRACT_ERROR(201000, "Failed to call DIDContract"),
    RET_DID_CREATE_DID_ERROR(201001, "Failed to create PlatON DID"),
    RET_DID_IDENTITY_NOTEXIST (201002, "The identity is not exist"),
    RET_DID_IDENTITY_ALREADY_REVOCATED(201003, "The identity has bean revocated"),
    RET_DID_IDENTITY_ALREADY_EXIST(201004, "The identity is already exist"),
    RET_DID_QUERY_DOCUMENT_ERROR (201005, "Failed to query document info"),
    RET_DID_INVALID(201006, "The did is illegal"),
    RET_DID_ADD_PUBLICKEY_ERROR(201007, "Failed to add public key"),
    RET_DID_PUBLICKEY_ALREADY_EXIST(201008, "The public key is already exist"),
    RET_DID_PUBLICKEY_NOTEXIST(201009, "The public key is not exist"),
    RET_DID_UPDATE_PUBLICKEY_ERROR(201010, "Failed to update public key"),
    RET_DID_PUBLICKEY_ALREADY_REVOCATED(201011, "The public key has bean revocated"),
    RET_DID_CONNOT_REVOCATION_LAST_PUBLICKEY(201012, "Can not revocation the last public key"),
    RET_DID_UPDATE_PUBLICKEY_SAME(201013, "the public key is the same"),
    RET_DID_SET_SERVICE_ALREADY_EXIST(201015, "The service is already exist"),
    RET_DID_SET_SERVICE_NOTEXIST(201016, "The service is not exist"),
    RET_DID_SET_SERVICE_ALREADY_REVOCATED(201017, "The service has bean revocated"),
    RET_DID_SET_STATUS_ERROR(201018, "Failed to set status for document"),
    RET_DID_SET_AUTHENTICATION_NOTEXIST(201019, "The authentication is not exist"),
    ...
    RET_CREDENTIAL_DID_ERROR(203002,"Credential did match error"),
    RET_CREDENTIAL_MATCH_PUBLICKEYID_ERROR(203004,"Did document not found publicKeyId"),
    RET_CREDENTIAL_MATCH_PUB_PRI_ERROR(203005,"Did publickey not match privatekey"),
    ...
    RET_CREDENTIAL_AUTH_STATUS_INVAILD(203011,"Did auth status invalid"),
    RET_CREDENTIAL_PUBLICKEY_STATUS_INVAILD(203012,"Did publickey status invalid"),
    RET_CREDENTIAL_PUBLICKEY_NOT_AUTH(203014,"Unauthorized disclosure of did's public key"),
    RET_CREDENTIAL_DID_NOT_FOUND(203015,"Not found did in contract"),

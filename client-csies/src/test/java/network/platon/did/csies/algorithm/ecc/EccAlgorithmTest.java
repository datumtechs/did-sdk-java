...
//        Assert.assertTrue(AlgorithmHandler.verifySignature(message, sign , keyPair.getPublicKey()));
        ...
        BigInteger signPublicKey = new  BigInteger("6766203317148505566676350160206388666081957434743472592258940645317731201159704411922018314987614271065631022602477658732737116652400718916009193668620848");
        ...
        signPublicKey = new  BigInteger("60397435036918893964972450153029773175999420717113046103153186420204787321453892319129515507655227981825758455348421862147752647900186998701743789692957232");

        signPublicKeyStr = Numeric.toHexStringWithPrefix(signPublicKey);
        System.out.println(signPublicKeyStr);
        address = Keys.getAddress(signPublicKeyStr);
        System.out.println(address);
